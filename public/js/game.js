...
function generateCharIntro(surname, givenName, bgKey) {
  ...
  const intros = {
    ...
    zhedong: `${fullName}，处州府青田县人氏。你自幼丧母，父亲在乡中开馆授徒，勉强糊口。家中虽清贫，却与村东头的刘伯温先生素有往来——刘先生是你父亲的同窗挚友，也是你真正的启蒙恩师。\n\n你七岁起便随刘先生读书。他教你不只是四书五经，更教天文兵法、术数奇门。月下竹篱旁，他常指着星空对你说：「治国如弈棋，不在一子之得失，在乎全局之势。」你十四岁那年，他已将毕生所学倾囊相授。临别时赠你一部手抄《百战奇略》，扉页题字：「此子颖悟，惜乎生不逢时。吾老矣，后生可畏。」\n\n刘先生致仕归乡后，你常去探望。去年冬天，你在他病榻前侍药月余。弥留之际，他握着你的手，声音已很微弱：「我这一生，辅佐太祖平天下，到头来却落得这般田地……你记住，读书人的骨气不能丢，但也不必白白送死。留有用之身，做该做的事。」言罢溘然长逝。你为他操持丧事，只见胡丞相遣太医送来的挽联到了，人却一个没来——浙东文官集团失了擎天之柱，风雨欲来。\n\n今年开春，你背着刘先生的遗书踏入应天府。宋濂先生念旧情，替你谋了个翰林院庶吉士的差事；方孝孺师兄也常来照应。但这也许正是你的机会——刘先生虽去，他的门生故旧尚在，这份人脉是你入仕的根基，也是悬在你头顶的刀。`,

    shanggu: `${fullName}，应天府江宁县人氏。你家是应天府数得上的富户，经营绸缎、茶叶和盐引，在秦淮河畔有三间铺面，在苏州、扬州也有分号。你自小锦衣玉食，五岁开蒙，请的是致仕的老儒；十二岁便跟着父亲学算盘、看账本、辨绸缎成色。\n\n然而你心里清楚，在这大明天下，商人再有钱也不过是砧板上的肉。沈万三的前车之鉴犹在眼前——富可敌国又如何？一纸诏令，抄家流徙。父亲花了大笔银子替你捐了个监生，又托人在通政司谋了个知印的差事，从九品，不入流。你今年二十三岁，穿着皂色官服站在衙门里时，常觉得自己像个穿着戏服的伶人。但你知道，这是你家从商入仕的唯一一步棋——走好了，便能改换门庭；走砸了，万劫不复。`,
...
async function showBackgroundSelection(surname) {
  ...
  const choicesArea = renderChoices(backgrounds, (choice) => {
    const bgMap = {
      '甲': { key: 'huaixi', bg: '淮西武将之后', age: 22, position: '殿前校尉', rank: 7,
              power: 15, people: 10, wisdom: 5, bond: 15, fame: 5, huaixi: 20 },
      '乙': { key: 'zhedong', bg: '浙东寒门书生', age: 20, position: '举人待选', rank: 0,
              power: 0, people: 10, wisdom: 20, bond: 5, fame: 10, zhedong: 15 },
      '丙': { key: 'shanggu', bg: '应天府商贾之子', age: 24, position: '通政司知印', rank: 9,
              power: 5, people: 5, wisdom: 10, bond: 10, fame: 5, jinchen: -5 },
      '丁': { key: 'qianyuan', bg: '落魄前元官员之后', age: 26, position: '翰林院抄吏', rank: 0,
